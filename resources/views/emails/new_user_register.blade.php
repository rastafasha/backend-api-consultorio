																	...
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tr>
																			<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																				<a href="#" target="_blank"><img src="https://consultorio.klyntic.com/assets/img/logoklyntic.png" width="150" height="100" editable="true" border="0" alt="" /></a>
																			</td>
																		</tr>
																	</table>
																	<!-- Logo -->
																														...
																														<tr>
																															<td align="center">
																																<table border="0" cellspacing="0" cellpadding="0" style="min-width: 200px;">
            																														...
            																														<tr>
            																															<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
            																																<img src="https://consultorio.klytic.com/QR/consultoriohcme.png" width="150" height="150" editable="true" border="0" alt="" />
																																	...
																																	<tr>
																																		<td class="btn-16 c-white l-white" bgcolor="#f3189e" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
																																			<multiline>
																																				<a href="https://consultorio.klytic.com/" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
																																					<span class="link c-white" style="text-decoration:none; color:#ffffff;">Acceder a Klintic</span>
																																				</a>
																																			</multiline>
																																		</td>
																																	</tr>
