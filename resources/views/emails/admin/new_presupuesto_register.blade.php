											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td class="text-12 c-grey l-grey a-right py-20" style="font-size:12px; line-height:16px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; color:#6e6e6e; text-align:right; padding-top: 20px; padding-bottom: 20px;">
															<webversion class="link c-grey" style="text-decoration:none; color:#6e6e6e;">
                                                                <span class="link c-grey" style="text-decoration:none; color:#6e6e6e;">Ver este correo en el Navegador</span>
                                                            </webversion>
														</td>
													</tr>
												</table>							<!-- END Top -->
																														...
																														<tr>
																															<td class="text-16 lh-26 a-center c-black" style="font-size:16px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; color:#282828;">
																																<multiline>
                                                                                                                                    ...
                                                                                                                                    <br>
																																	<em>"Email del Doctor: {{$presupuesto->doctor->email}}"</em>
                                                                                                                                    <br>
																																	<em>"Teléfono del Doctor: {{$presupuesto->doctor->mobile}}"</em>
                                                                                                                                    <br>
																																	<em>"Creado: {{$presupuesto->created_at}}"</em>
                                                                                                                                    <br>
																																	<em>"Descripcion: {{$presupuesto->description}}"</em>
                                                                                                                                    <br>
																																	<br>
																	<strong>Detalles Médicos</strong>
																	<ul>
																																		@if(!empty($presupuesto->medical) && is_array($presupuesto->medical))
																																			@foreach($presupuesto->medical as $item)
																																				<li>{{ $item->name_medical }}: ${{ $item->precio }}</li>
																																			@endforeach
																																		@else
																																			<li>No hay detalles médicos disponibles.</li>
																																		@endif
																																	</ul>


																																	<em>"Total: ${{$presupuesto->amount}}"</em>
                                                                                                                                    <br>
