...
class RoleAndPermissionSeeder extends Seeder
{
    public function run()
    {
        // 1. SANEADO: Limpieza de caché de Spatie por seguridad
        app()[\Spatie\Permission\PermissionRegistrar::class]->forgetCachedPermissions();

        // Lista de permisos indexados limpia y expandida
        $permissions = [
        ...
        // Asignación total al Superadmin
        ...
        // 🟢 ASIGNACIONES CORREGIDAS Y POTENCIADAS PARA LA CLÍNICA:
        // Corregido el float 13.14 por comas limpias
        $adminRole->syncPermissions([2, 5, 8, 9, 10, 12, 13, 14, 15, 17, 18, 19, 20, 22, 23, 24, 26, 27, 28, 29, 30, 35, 38, 40, 41, 42, 44, 52, 53, 54, 68]);
        
        $doctorRole->syncPermissions([3, 6, 7, 10, 12, 13, 15, 17, 49, 50, 52, 53, 54, 55, 56, 57, 62, 63, 64, 65, 66, 67, 68]); 
        
        $guestRole->syncPermissions([12, 20]); 
        
        // 🏢 RECEPCIÓN: Ahora tiene poder para ver pacientes, citas, reportes de cobros y presupuestos (48, 49)
        $recepcionRole->syncPermissions([2, 9, 13, 14, 18, 19, 22, 23, 24, 26, 27, 30, 35, 38, 40, 41, 44, 48, 49, 62, 68]);
        
        // 🏢 ASISTENTE: Potenciado con los mismos accesos de control financiero de recepción centralizada
        $asistenteRole->syncPermissions([3, 10, 12, 13, 14, 22, 23, 24, 30, 35, 38, 48, 49, 62, 68]); 
        
        $laboratorioRole->syncPermissions([12, 41, 42, 68]); 
        $enfermeraRole->syncPermissions([13, 14, 22, 23, 68]); 
    }
}