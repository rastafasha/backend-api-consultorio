...
class DashboardkpiController extends Controller
{
    ...
    public function dashboardAdminYear(Request $request)
    {
        $year = $request->year;
    ...
    public function dashboardDoctorYear(Request $request)
    {
    ...
    public function dashboardPatient(Request $request)
    {
    ...
    public function dashboardPatientYear(Request $request)
    {
